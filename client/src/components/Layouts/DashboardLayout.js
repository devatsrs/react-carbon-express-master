...
import { Search20, UserAvatar24, Login16, Notification20, AppSwitcher20 } from "@carbon/icons-react";
    ...
    return (
      <div>
        ...
        <Header aria-label="IBM Platform Name">
          ...
          <HeaderGlobalBar>
            <HeaderGlobalAction aria-label="Search" onClick={() => alert("search click")} >
              <Search20 />
            </HeaderGlobalAction>
            <HeaderGlobalAction
        ...
        {/* right bar panel  */}
        <HeaderPanel color={coolGray100} aria-label="Header Panel" expanded={this.state.isRightSideNavExpanded}>
        ...
        <aside className="bx--side-nav" color={gray100}>
          <Sidebar color={gray100} isSideNavExpanded={this.state.isSideNavExpanded}></Sidebar>
        </aside>
